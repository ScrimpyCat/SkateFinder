...
RSpec.describe SkateGeoController, :type => :controller do
    ...
    describe 'PUT #update' do
        ...
        it_behaves_like 'update boolean', :park
        ...
        it_behaves_like 'update boolean', :undercover
        ...
        it_behaves_like 'update boolean', :lights
        it_behaves_like 'update boolean', :private_property
